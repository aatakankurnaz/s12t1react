export const Main = () => {
    return (
        <main className="flex justify-center mt-20">
            ...
            <section>
                <div className="max-w-2xl mx-auto p-8 bg-white shadow-inner rounded-tr-xl rounded-br-xl ">
                    <blockquote className="text-2xl italic text-gray-700 mb-6 font-serif border-l-4 pl-4 border-blue-500">
                    ...
                    <p className="font-semibold text-xl text-gray-800">Atakan KURNAZ</p>
                    <p className="font-medium text-lg text-gray-600">Frontend Developer</p>
                ...
                <div className="max-w-2xl mx-auto p-8 bg-white shadow-inner rounded-tr-xl rounded-br-xl flex px-5">
